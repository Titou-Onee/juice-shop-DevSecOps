pipeline{
    ...
    stages{   
                ...
                steps {
                    ...
                    vaultSecrets: [
                        ...
                        sh ''' 
                            ...
                            export IMAGE_FULL_REF="env.REGISTRY/env.NAMESPACE/env.IMAGE_NAME"
        ...
        stage('Deploy container image'){
            steps{
                withVault(configuration: [engineVersion: 2, vaultCredentialId: 'Jenkins_prod_approle', vaultUrl: "${env.VAULT_URL}"], 
